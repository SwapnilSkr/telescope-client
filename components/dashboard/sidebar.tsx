...
const menuItems = [
  ...
  {
    icon: Realtime,
    fillIcon: RealtimeFill,
    label: "Real-Time Feed",
    href: "/dashboard/real-time-feed",
  },
  {
    icon: Alert,
    fillIcon: AlertFill,
                ...
                <div className="relative w-[20px] h-[20px] mr-3 flex items-center justify-center">
                  {item.icon === "svg" ? (
                    ...
                    <>
                      ...
                      >
                        {item.reactIcon && (
                          <item.reactIcon size={20} color="white" />
                        )}
                      </div>
                      <div
                        className={`absolute inset-0 ${
                      ...
                      >
                        {item.reactIconFill && (
                          <item.reactIconFill size={20} color="#A958E3" />
                        )}
                      </div>
                    </>
                  ) : (
