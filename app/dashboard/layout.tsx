  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 bg-[#020017] flex flex-col overflow-hidden">
        <header
          className="shadow-sm z-10 h-[120px]"
          style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.09)" }}
        >
          <div className="max-w-7xl mx-auto lg:px-[30px] pt-[30px] sm:px-6 flex justify-between items-center">
            <div className="flex flex-col" style={{ lineHeight: "1.2" }}>
              <h1 className="text-[30px] font-[500] text-white">
                Hi {user?.username}
              </h1>
              <p className="text-[18px] font-[300] text-[#C0C0C0]">
                You are safe with Telescope
              </p>
            </div>
            ...
            <div className="hidden md:flex relative flex-1 max-w-xl mx-8">
              <div className="w-full relative flex items-center">
                <div className="absolute left-5">
                  ...
                  >
                    <path
                      d="M19.5859 18.8544L25.4875 24.7559"
                      stroke="white"
                      stroke-width="2.23565"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M1.88086 11.2663C1.88086 16.8537 6.41037 21.3833 11.9978 21.3833C14.7963 21.3833 17.3296 20.247 19.1611 18.4106C20.9864 16.5806 22.1148 14.0552 22.1148 11.2663C22.1148 5.67886 17.5852 1.14935 11.9978 1.14935C6.41037 1.14935 1.88086 5.67886 1.88086 11.2663Z"
                      stroke="white"
                      stroke-width="2.23565"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <input
                  type="text"
                  placeholder="search for threat keywords, actors, channels"
                  className="w-full py-3 px-14 rounded-full bg-[#020017] text-white text-sm focus:outline-none focus:ring-1 focus:ring-[#B435D4] placeholder-gray-400"
                  style={{
            ...
            <div className="notif-profile-container flex justify-center items-center gap-x-[20px]">
              <div
                className="notif-container cursor-pointer relative"
              ...
              >
                ...
                {notificationOpen && (
                  <div
                    ...
                    style={{
                      border: "1px solid rgba(248, 248, 248, 0.04)",
                      borderRadius: "20px",
                      background: "#191919",
                  ...
                  >
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      ...
                      {[1, 2, 3].map((item) => (
                        <div
                          key={item}
                          className="p-4 hover:bg-[#1A1A2E] text-white border-b"
                          style={{
                            borderBottom: "1px solid rgba(255, 255, 255, 0.04)",
                          }}
                        >
                          ...
                          <p className="text-gray-400 text-xs mt-1">
                            A potential threat was detected in your network
                          </p>
                    ...
                    <div className="p-2">
                      <button className="w-full text-left p-3 text-white hover:bg-[#1A1A2E] rounded transition-colors flex items-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                className="profile-container cursor-pointer relative"
                ref={profileBtnRef}
              >
                <div onClick={() => setProfileOpen(!profileOpen)}>
                  <Avatar className="border-2 border-[#B435D4] bg-transparent">
                    <AvatarFallback className="bg-transparent text-[#B435D4]">
                ...
                {profileOpen && (
                  ...
                  >
                    ...
                    >
                      <Avatar className="h-8 w-8 border-2 border-[#B435D4] bg-transparent">
                        <AvatarFallback className="bg-transparent text-[#B435D4]">
                          {user?.username ? user.username[0].toUpperCase() : ""}
                        </AvatarFallback>
                      </Avatar>
                    ...
                    <div className="p-2">
                      ...
                      >
                        ...
                        >
                          <path
                            d="M7.66283 6.50865C7.92974 3.409 9.52261 2.14331 13.0097 2.14331H13.1216C16.9704 2.14331 18.5116 3.68452 18.5116 7.53325V13.1471C18.5116 16.9958 16.9704 18.537 13.1216 18.537H13.0097C9.54845 18.537 7.95557 17.2885 7.67144 14.2405M12.915 10.3315H3.11668M5.03674 7.44715L2.15234 10.3315L5.03674 13.2159"
                            stroke-width="1.40893"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          />
                        </svg>
